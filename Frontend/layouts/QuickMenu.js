...
const QuickMenu = ({showNotify}) => {
    ...
    const QuickMenuDesktop = () => {
        ...
        <ListGroup as="ul" bsPrefix='navbar-nav' className="navbar-right-wrap ms-auto d-flex nav-top-wrap">
          {showNotify && <Dropdown as="li" className="stopevent">
                ...
                >
                    <Dropdown.Item as="div" className="px-4 pb-0 pt-2" bsPrefix=' '>
                            <div className="lh-1 ">
                                ...
                                <Link href="/settings" className="text-inherit fs-6">View my profile</Link>
                            </div>
                            <div className=" dropdown-divider mt-3 mb-2"></div>
                    </Dropdown.Item>
                    <Dropdown.Item eventKey="2" onClick={() => router.push('/dashboard')}>
                        <i className="fe fe-inbox me-2"></i> Dashboard
                    </Dropdown.Item>
